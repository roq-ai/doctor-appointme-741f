...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['system-administrator', 'medical-staff', 'receptionist', 'insurance-provider'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Patients', path: '/patients', entity: 'patient', service: AccessServiceEnum.PROJECT, icon: FiHeart },
