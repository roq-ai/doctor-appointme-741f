...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'appointment.count', 'availability.count', 'insurance.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('appointment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('availability', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'availability',
          header: 'Availability',
          accessorKey: 'availability',
          cell: ({ row: { original: record } }: any) => record?._count?.availability,
        }
      : null,
    hasAccess('insurance', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.insurance,
        }
      : null,
